...
import setupGuideCss from "./setup-guide.css";

export const links = () => [{ rel: "stylesheet", href: setupGuideCss }];
export const SetupGuide = ({
  ...
  const [expanded, setExpanded] = useState(
    items.findIndex((item: any) => !item.complete)
  );
            ...
            <InlineStack blockAlign="center" gap="200">
              ...
              {completedItemsLength !== items.length ? (
                <div style={{ width: "100px" }}>
                  <ProgressBar
                    progress={
                      (items.filter((item: any) => item.complete).length /
                        items.length) *
                      100
                    }
                    size="small"
...
const SetupItem = ({
  ...
  primaryButton?: { content: string; props: any };
  secondaryButton?: { content: string; props: any };
  id: number;
  ...
  return (
    <Box
      ...
      paddingInline={"300"}
    >
      <div className={`setupItem ${expanded ? "setupItemExpanded" : ""}`}>
        <InlineStack gap="200" align="start" blockAlign="start" wrap={false}>
          ...
          >
            <BlockStack gap="200" id={`${id}-blockstack`}>
              <InlineStack gap={"300"}>
              ...
              <Collapsible open={expanded} id={`${id}-collapsible`}>
                      ...
                      <ButtonGroup gap="loose">
                        ...
                        {secondaryButton ? (
                          <Button
                            ...
                            onClick={() => {
                              secondaryButton.props.onAction();
                            }}
                          >
